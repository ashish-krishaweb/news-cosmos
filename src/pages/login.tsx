...
export default function Login() {
    return (
        <LoginLayout>
            <main>
                <div className="flex flex-col items-center w-full justify-center pt-10 max-sm:px-4">
                    <LoginForm />
                    <div className='mt-2'>
    ...
    return (
        <form className="bg-white rounded-sm w-full max-w-[474px] min-h-[493px]">
            <div className="py-5 text-center border-b border-solid">
                <h2 className="text-[#ED6C27] text-3xl font-[500]">Login</h2>
            </div>
            <div className="py-5 px-4 md:px-16">
                ...
                <div className="form-container flex flex-col gap-4">
                    ...
                    <div className="flex max-sm:flex-col sm:justify-between sm:items-center gap-2 sm:gap-0">
                        ...
                        <button className="px-5 py-2 bg-blue-500 rounded-md text-white text-xl">Login</button>
                    </div>

                    <div className="flex gap-2">
                        <p className="text-gray-500">New member?</p>
                        <Link href="/signup" className="text-blue-500 font-[500]">Sign up</Link>
                    </div>
                </div>
            </div>
        </form>
